        ...
        <div className='absolute w-full'>
            <header className='flex justify-between px-2 items-center'>
                <div className='md:py-6 md:px-10'>
                    <svg width="80" height="80" viewBox="0 0 87 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="Vector">
                            ...
                            <path d="M47.9344 6.5C47.9344 3.73858 50.173 1.5 52.9344 1.5H79.3374C83.9967 1.5 86.1235 7.31141 82.5648 10.3189L64.2558 25.7921C62.1813 27.5452 61.8858 30.6337 63.5901 32.7485L85.4418 59.8625C88.0779 63.1334 85.7497 68 81.5487 68H47.9344V6.5Z" fill="#463F2D" />
                        </g>
                    </svg>
                </div>
                <div>
